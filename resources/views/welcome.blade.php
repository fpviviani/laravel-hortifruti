            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">As verduras e frutas mais frescas que você irá encontrar!</h1>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Entre em contato!</h2>
                        <hr class="divider light my-4" />
                        <p class="text-white mb-5">Dúvidas, sugestões ou problemas com alguma encomenda? Sem estresse! Nos conte o que está acontecendo e resolvemos pra você!</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fas fa-phone fa-3x mb-3 text-white"></i>
                        <div class="text-white">(35) 3628-4567</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-white"></i>
                        <div class="text-white">contato@hortifruti.com</div>
                    </div>
                </div>
            </div>
        </section>
